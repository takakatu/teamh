...
home_appliances_smartphon_accessories = home_appliances.children.create(name: "スマートフォンアクセサリ")
...
kids_babyboy.children.create([{name: "トップス"},
                            ...
                            {name: "ロンパース"},
                            {name: "パジャマ"}])
kids_shoes.create([{name: "スニーカー"},
                            {name: "サンダル"},
                            {name: "ブーツ"},
                            {name: "長靴"}])
kids_accessories.create([{name: "靴下"},
                            {name: "帽子"},
                            {name: "ベルト"},
                            {name: "マフラー"},
                            {name: "手袋"}])
kids_hobby.create([{name: "トップス"},
                            {name: "お風呂のおもちゃ"},
                            {name: "ガラガラ"},
                            {name: "オルゴール"}])                            
